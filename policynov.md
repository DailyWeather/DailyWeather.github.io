<h1><center>每日读书隐私政策</center></h1>
<div align="right">（生效时间2020年12月15日）</div>
您在使用每日读书服务时，每日读书将按照法律法规的规定，保护您的个人信息及隐私安全。因每日读书的成功取决于建立与维护对用户的良好信誉，我们会坚定的实施隐私政策。 如您未满18周岁，请您在监护人陪同下仔细阅读并充分理解本隐私政策，并征得监护人的同意后使用我们的服务或向我们提供信息。

您使用或继续使用每日读书，都表示您同意我们按照本《隐私政策》收集、使用、储存和分享您的信息。
...
COOKIES和设备信息标识等同类技术是互联网中普遍使用的技术。当您使用每日读书及相关服务时，我们可能会使用相关技术向您的设备发送一个或多个COOKIES或匿名标识符，以收集、标识您访问、使用本产品时的信息。我们承诺，不会将COOKIES用于本隐私政策所述目的之外的任何其他用途。
...
2.  数据分析及异常情况排查
    ...
    * 在使用每日读书时，我们可能会使用COOKIES对浏览活动进行记录，用于排查崩溃、延迟的相关异常情况以及探索更好的服务方式。
3. COOKIES的清除  
...
3. 遵守法院命令或其他法律程序的规定；
4. 遵守相关政府机关的要求；
5. 我们认为为遵守适用的法律法规、维护社会公共利益、或保护我们、我们的客户、其他用户或雇员的人身和财产安全或合法权益或公共安全及利益所合理必需的；及根据每日读书各服务条款及声明中的相关规定，或者每日读书认为必要的其他情形下。
